...
final class MysqlUserRepository implements UserRepository
{
    ...
    //retorna l'ultim usuari que hem utilitzat
    ...
    //li passem el token i busca el usari amb aquest token
    ...
    //busca un usuari que coincideix amb ek introduit per l'usuari
